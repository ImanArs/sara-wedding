    ...
    <section className="relative min-h-screen flex flex-col bg-[url('/bg/bg_2.png')] bg-top bg-cover bg-no-repeat py-16 px-6 text-center overflow-hidden">
      ...
      <div className="pointer-events-none select-none absolute inset-0 z-0">
        ...
        <img
          src="/fl/roses.png"
          alt=""
          className="absolute right-2 bottom-2 w-[140px] h-auto opacity-90 animate-sway"
      ...
      <div className="relative z-10 mx-auto max-w-[680px] text-slate-700">
        ...
        {/* Основной текст */}
        <p className="mt-6 whitespace-pre-line text-balance font-serif text-[18px] leading-8 opacity-90">
          С большой радостью и трепетом мы приглашаем вас разделить с нами
          счастье неповторимого события — день нашей свадьбы.
        </p>
        ...
        <div className="mt-10">
          ...
          <p className="mt-2 text-[16px] opacity-80">
            Адрес: г. Бишкек, ул. Мадиев 22Б
          </p>
        </div>
      ...
      <p className="relative z-10 mt-auto">Той ээлери</p>
    </section>
  );
}
